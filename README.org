...
- [[https://codeberg.org/scip/gosubst/][gosubst]]: modify file contents or file names using regular expressions (a rewrite of the 25 years old [[https://codeberg.org/scip/subst/][perl subst script]] in go)
- [[https://codeberg.org/scip/esctl/][esctl]]: a comprehensive and powerful Elasticsearch cli tool
- [[https://codeberg.org/scip/mapmap/][mapmap]]: a golang module to apply functions to maps and slices (experimental)
- [[https://codeberg.org/scip/mosscap/][mosscap]]: a tiny cli tool to automate tasks
