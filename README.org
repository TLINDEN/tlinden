...
- [[https://github.com/TLINDEN/epuppy/][epuppy]]: terminal epub viewer
- [[https://github.com/TLINDEN/ts/][ts]]: generic cli timestamp parser and calculator tool
- [[https://github.com/TLINDEN/swayipc/][swayipc]]: go bindings to control sway and swayfx
- [[https://github.com/TLINDEN/swaycycle/][swaycycle]]: alt-tab window cycler for sway/swayfx, uses the swayipc module.
